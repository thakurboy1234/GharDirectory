<div class="socials mb-3 pb-2 border-bottom w-100">
    ...
    <ul>
        ...
        <li>
            <a target="_blank"  data-action="share/whatsapp/share" href="https://api.whatsapp.com/send/?text={{ urlencode(url()->current()) }}" title="Whatsapp"><i class="fab fa-whatsapp"></i></a>
